        ...
        return (
          <group rotation={[0.3, -0.3, 0]}>
            ...
            <mesh castShadow position={[-0.12, 0.14, 0.08]}>
              ...
              <meshStandardMaterial color={ac} emissive={ac} emissiveIntensity={0.55} roughness={0.3} metalness={0.2} />
            </mesh>
            {/* Slice 3 – small (~20%) */}
            <mesh castShadow position={[0.06, 0.14, -0.06]}>
              <cylinderGeometry args={[0.65, 0.65, 0.28, 32, 1, false, Math.PI * 1.6, Math.PI * 0.4]} />
              <meshPhysicalMaterial roughness={mat.roughness * 1.2} metalness={mat.metalness * 0.8} transmission={mat.transmission} thickness={mat.thickness} clearcoat={mat.clearcoat} clearcoatRoughness={mat.clearcoatRoughness} ior={mat.ior} color={mat.color} emissive={mat.emissive} emissiveIntensity={mat.emissiveIntensity * 0.3} />
            </mesh>
          </group>
        );
      }}
