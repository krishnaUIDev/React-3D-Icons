      ...
      {(mat) => (
        <group rotation={[0.4, -0.4, 0.7]} position={[0, 0, 0]}>
          ...
          <mesh castShadow position={[0, 0.7, 0]}>
            ...
            <meshStandardMaterial roughness={0.1} metalness={0.9} color="#d4af37" /> {/* Gold ring */}
          </mesh>

          {/* Eraser */}
          <mesh castShadow position={[0, 0.84, 0]}>
            <cylinderGeometry args={[0.16, 0.16, 0.16, 16]} />
            <meshStandardMaterial roughness={0.9} metalness={0.1} color="#fda4af" /> {/* Soft pink eraser */}
          </mesh>

          {/* Sharpened Wood Cone Tip */}
          <mesh castShadow position={[0, -0.6, 0]} rotation={[Math.PI, 0, 0]}>
            <coneGeometry args={[0.16, 0.3, 16]} />
            <meshStandardMaterial roughness={0.7} metalness={0.05} color="#fed7aa" /> {/* Light wood tone */}
          </mesh>

          {/* Graphite Lead Tip */}
          <mesh castShadow position={[0, -0.71, 0]} rotation={[Math.PI, 0, 0]}>
            <coneGeometry args={[0.06, 0.12, 16]} />
            <meshStandardMaterial roughness={0.3} metalness={0.8} color="#27272a" /> {/* Charcoal graphite tip */}
          </mesh>
