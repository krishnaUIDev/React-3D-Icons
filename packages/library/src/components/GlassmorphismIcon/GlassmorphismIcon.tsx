      ...
      {(mat) => (
        <group rotation={[0.2, -0.35, 0.1]} position={[0, 0, 0]}>
          ...
          <mesh position={[-0.32, -0.18, -0.22]} castShadow receiveShadow>
            ...
            <meshStandardMaterial roughness={0.2} color="#ec4899" emissive="#701a75" emissiveIntensity={0.2} /> {/* Vivid pink */}
          </mesh>

          {/* Background Primitive 2: Shiny Metallic Cylinder (Behind Glass) */}
          <mesh position={[0.28, 0.24, -0.28]} rotation={[Math.PI / 4, Math.PI / 6, 0]} castShadow receiveShadow>
            <cylinderGeometry args={[0.16, 0.16, 0.6, 24]} />
            <meshStandardMaterial roughness={0.1} metalness={0.9} color="#38bdf8" /> {/* Electric cyan */}
          </mesh>
          ...
          <mesh position={[0, 0, 0.12]} castShadow receiveShadow>
            ...
            <meshPhysicalMaterial
              roughness={props.preset === "glassmorphism" ? 0.05 : Math.max(0.05, mat.roughness - 0.05)}
              ...
              color={props.preset === "glassmorphism" ? (props.theme === "dark" ? "#ffffff" : "#e2e8f0") : mat.color}
              emissive={props.preset === "glassmorphism" ? (props.theme === "dark" ? "#e4e4e7" : "#a1a1aa") : mat.emissive}
