...
import { FolderMinusIconProps } from "./types";

export function FolderMinusIcon(props: FolderMinusIconProps) {
  return (
    <SharedWrapper iconId="folderminus" {...props}>
      {(mat) => (
        <group rotation={[0.22, -Math.PI / 6, 0.05]} position={[0, 0, 0]} scale={[1.4, 1.4, 1.4]}>
          ...
          {/* Raised 3D Minus Symbol on Bottom Right Front Cover (Emissive Accent Color) */}
