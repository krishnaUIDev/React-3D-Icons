...
const makeEnhanceElement = (
  ...
  const enhance = (node: React.ReactNode): React.ReactNode => {
    ...
    const isShape =
      ...
      ["path", "circle", "rect", "line", "polygon", "polyline", "ellipse"].includes(node.type);
    ...
    case "hearteyes":
      return (
        ...
        >
          ...
          <path d="M8 14s1.5 2 4 2 4-2 4-2" />
          <path
            d="M7 8.5C7 7.5 8 7 8.5 7.5c.5-.5 1.5 0 1.5 1a2 2 0 0 1-1.5 1.5C7 8.5 7 8.5 7 8.5z"
            fill={strokeColor}
          />
          <path
            d="M14 8.5c0-1 1-1.5 1.5-1 .5-.5 1.5 0 1.5 1a2 2 0 0 1-1.5 1.5c-1.5-1.5-1.5-1.5-1.5-1.5z"
            fill={strokeColor}
          />
        </svg>
      );
    ...
    case "folderplus":
      return (
        <svg
          ...
          className="w-full h-full"
        >
          <path d="M4 20h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.93a2 2 0 0 1-1.66-.9l-.82-1.2A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2zM12 10v6M9 13h6" />
        </svg>
      );
    case "folderminus":
      return (
        <svg
          ...
          className="w-full h-full"
        >
          <path d="M4 20h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.93a2 2 0 0 1-1.66-.9l-.82-1.2A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2zM9 13h6" />
        </svg>
      );
    case "foldercheck":
      return (
        <svg
          ...
          className="w-full h-full"
        >
          <path d="M4 20h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.93a2 2 0 0 1-1.66-.9l-.82-1.2A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2zM9 13l2 2 4-4" />
        </svg>
      );
    case "calendarplus":
      return (
...
export const Fallback2D: React.FC<Fallback2DProps> = ({
  ...
  const isDark = theme === "dark";
  const strokeColor =
    (color.toLowerCase() === "#ffffff" || color.toLowerCase() === "#fff") && !isDark
      ? "#475569"
      : color;
  ...
  const cloner = makeEnhanceElement(
    strokeGradId,
    fillGradId,
    shadowId,
    strokeColor,
        ...
        <defs>
          <filter id={shadowId} x="-20%" y="-20%" width="140%" height="140%">
            <feDropShadow
              dx="0"
              dy="1.5"
              stdDeviation={grad.shadowRadius}
          ...
          <radialGradient id={`plate-bg-gradient-${id}`} cx="50%" cy="50%" r="70%">
            <stop
              offset="0%"
              stopColor={isDark ? "#1f2937" : "#ffffff"}
              stopOpacity={isDark ? 0.9 : 0.95}
            />
            <stop
              offset="100%"
              stopColor={isDark ? "#0b0f19" : "#f8fafc"}
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" className="w-full h-full" style={{ overflow: "visible" }}>
      <defs>
      ...
      <g transform="translate(1.8, 1.8) scale(0.85)">{enhancedChildren}</g>
    </svg>
  );
};
