...
import { Heart, Grid, Package, Github, AlertCircle, Figma, Twitter, Dribbble, Linkedin, Instagram, Youtube } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 text-[11px] font-bold uppercase tracking-wider text-zinc-500 dark:text-zinc-400">
          ...
          <a
            ...
            className="flex items-center gap-1.5 hover:text-indigo-600 dark:hover:text-indigo-400 transition"
          >
            <Dribbble size={12} className="text-zinc-400" />
            <span>Dribbble</span>
          </a>
          <a
